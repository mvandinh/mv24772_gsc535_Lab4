...
public class A4SampleTest2 {
	 ...
	 */
	public void testWalk() throws InvalidCritterException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
	 ...
	 */
	public void WalkEnergyTest() throws InvalidCritterException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		Critter.makeCritter("MyCritter1");
...
//		while (!c.isDead()) {
	 ...
	 */
	@Test
	public void RunDuringFightTest() throws InvalidCritterException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		int x = 0;
		int y = 0;
		int num = 2;
		...
		runner.setX_coord(0);
		runner.setY_coord(0);
		fighter.setX_coord(1);
		fighter.setY_coord(0);
		assertEquals(num, TestCritter.getPopulation().size());
		assertFalse(runner.look(0, false) == null);
		System.out.print(runner.look(0, false));
		Critter.worldTimeStep;
	}
